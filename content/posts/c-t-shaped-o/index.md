...
slug = 'c-t-shaped-o'
draft = false
description = "I was never comfortable with the CTO title."
[sitemap]
  priority = 0.8
[params]
  series_number = 7
  og_image = '/posts/c-t-shaped-o/t-shaped.png'
...
After my last CTO role ended, I found myself questioning the title for the first time. Not the work - I wanted something more customer-facing, closer to the business problems rather than the delivery machinery. I considered sales. I did advisory work. Eventually I [built something on my own](/posts/contextrocket/) - product design, branding, growth, and engineering, all in one project. That was when the label stopped mattering and the shape underneath became clear.
