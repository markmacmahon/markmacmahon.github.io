...
draft = false
description = "AI replaced the need for juniors. Or so the thinking goes."
[sitemap]
  priority = 0.8
[params]
  series_number = 9
...
Late one night in the basement of a Georgian building on Pembroke Street in Dublin, myself and [Conor](https://www.linkedin.com/in/conor-mcguire-23354522/) were deep in code. The office was in the lower ground floor - beautiful building above, strip lighting and desks below. We were heads down when a rat slipped in under the front door, ran down the stairs, and froze. We froze. I think the rat was more shocked than we were. It turned and bolted back up the stairs and out of the building.

{{< post-image src="orbism-rat.png" alt="Two developers startled by a rat in a basement office - Orbism, Dublin, 1998" caption="Orbism, 1998. Elegant facade above. Rat below." width="480px" >}}

That was Orbism in 1998. A small software company in the basement of a Georgian terrace just off Fitzwilliam Square. One of the most beautiful corners of Dublin. The Irish tech scene before anyone called it a tech scene.

{{< post-image src="fitzwilliam-square.jpg" alt="Georgian red-brick terrace on Fitzwilliam Square, Dublin" caption="Fitzwilliam Square. Elegant facade above, strip lighting and startups below." width="480px" >}}
...
[Cormac Kenevey](https://www.kenevey.com/), [Dermot Hennessy](https://www.linkedin.com/in/dermothennessy/), [Bob Boles](https://www.linkedin.com/in/bob-boles/), and others came from UCD's [Higher Diploma in Computer Science](https://www.cs.ucd.ie/PostgraduateProgrammes/HDip_(ICT_Skills_Conversion)/) - a one-year conversion programme for graduates from other disciplines. One year. And they were holding their own alongside experienced engineers from day one. That says something about the environment they walked into.

Cormac left software entirely. His real talent was music. Today he's one of the most recognised [jazz vocalists on the Irish scene](https://www.kenevey.com/). If you'd told me in 1998 that the quiet engineer across the desk would end up performing at jazz festivals across Europe, I wouldn't have believed it. You never know where people will end up.

[John Butler](https://www.linkedin.com/in/jfbutler/) found his specialty at Orbism. He got deep into CORBA - specifically the side of it that involved integrating legacy systems, the COBOL backends that big financial institutions still ran on. That niche took his career in a completely different direction from the rest of us. To Switzerland first, then eventually to the United States. He found a seam at Orbism that nobody else was mining, and followed it for decades.

## Iona

Within a week of joining Orbism, I was inside Iona.

The contrast was immediate. From a basement on Pembroke Street to Iona's offices on Shelbourne Road in Ballsbridge - a hundred thousand square feet of one of the first Irish companies to float on NASDAQ, alongside [SmartForce](https://en.wikipedia.org/wiki/SmartForce). At its height, Iona was valued at $1.75 billion. This was a different world.
...
The founders - [Chris Horn](https://en.wikipedia.org/wiki/Chris_Horn_(computer_scientist)), [Sean Baker](https://www.siliconrepublic.com/careers/the-friday-interview-sean-baker-iona-technologies), and [Annrai O'Toole](https://www.linkedin.com/in/aotoole/) - had started as academics at Trinity College Dublin, each putting in a thousand pounds in 1991. By the time I walked in, it was a global company with [Steve Vinoski](https://steve.vinoski.net/) as chief architect and some of the sharpest distributed systems engineers in the industry.
...
One detail I didn't expect: Iona was using the same Vantiv customer support system I'd used at AOL the year before, when I was answering support tickets as a student. The same screens. The same workflows. Except now I was on the engineering side. You see the same problems again, from a different altitude.

## Norkom

The other placement Orbism sent me on was [Norkom Technologies](https://en.wikipedia.org/wiki/Norkom).

[Paul Kerley](https://www.linkedin.com/in/paulkerley/) had founded Norkom in 1998 - the same year as Orbism. The company was building CRM and analytics software for telecoms and financial services, with a particular focus on churn prediction and customer behaviour algorithms. It had a startup energy but was well funded from the start.

This was a different kind of pressure. Late nights in the office - my first experience of working right through the night, still at my desk at eight in the morning when everyone else started arriving for work. The eyes were falling out of my head. A lot of it came from inexperience. I was still a junior, still learning the gap between what I thought the work required and what it actually demanded.
...
{{< image-pair src1="toners.jpeg" alt1="Toners pub exterior on Baggot Street, Dublin" caption1="Toners on Baggot Street.<br>Still pulling pints since 1818." src2="toners-interior.webp" alt2="Toners pub interior showing the snug and bar" caption2="The snug. Best in Dublin,<br>according to the sign on the door." >}}

Dublin was in the middle of something. European Union money was flowing. US tech investment was arriving - Intel, the multinationals, the IDA campaigns that were filling offices across the city. The [Celtic Tiger](https://en.wikipedia.org/wiki/Celtic_Tiger) was not yet a cliche. It was just a feeling - that things were accelerating, that there was work and money and possibility, that Ireland had turned a corner.
...
I freelanced at GE Global Exchange Services. Then at Ericsson, working on radio network systems at their centre in Clonskeagh. The money was good. The work was steady. I was twenty-four, earning more than I'd imagined, and able to buy a house. The market showed no sign of slowing down.

I was at Ericsson when 9/11 happened. Everything changed after that. But that's a story for another post.

People change. Cities change. Relationships change. The company in the basement doesn't exist any more. The Dublin I knew in 1998 isn't the Dublin of today. But what was installed there moved with the people who carried it.

## What Mentorship Actually Builds

At Orbism I was the one being mentored. Over the years that reversed. At every company since - Nokia, startups, Luzia - some of the most exceptional people I've worked with came in as graduates, working students, and interns. Not as a compromise. As a deliberate choice. I'd seen what Orbism had done with a room full of juniors and good mentors, and I wanted to replicate it. It worked. People who arrived as interns grew into engineers I'd trust with anything.

The mentorship I received at Orbism didn't just shape my career. It shaped how I built teams.
...
Orbism was a small company. It lasted a few years. But the mentorship culture that Gavin and Richard created produced people who went on to build things across software and finance, in Ireland, Switzerland, the United States, and beyond.

That doesn't happen if you only optimise for today's output.

**Companies that hire only seniors are renting capability. Companies that mentor juniors are building something that compounds.** The senior-only approach gives you a team that ships. Mentorship gives you a team that lasts.

## The Light

For a while, everything lined up. Java arrived at exactly the right moment. I landed in a room full of people who cared about craft. The market was generous. The momentum felt inevitable.
